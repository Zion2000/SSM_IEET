		...
		<table border="1" width="300">
			...
			<c:forEach items="${personnels}" var="s">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/queryByPid/${s.pid}">编辑</a></td>	
				</tr>
			</c:forEach>
		</table>
			<h2><a href="${pageContext.request.contextPath}/personnelAll">刷新</a></h2>
			</div>
